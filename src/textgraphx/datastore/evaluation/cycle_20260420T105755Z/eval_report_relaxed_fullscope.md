...
- entity: micro F1=0.287 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.264 | entity, event, timex, relation |
| 82738 | 0.330 | entity, event, timex, relation |
| 62405 | 0.341 | entity, event, relation |
| 96770 | 0.390 | entity, event, timex, relation |
...
| relation | 2 | 70 | 21 | 0.028 | 0.087 | 0.042 |
...
- relation: low F1 (0.042) - inspect extraction and matching rules for this layer.
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (93,), 'entity', (104, 105, 106), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 25 | 22 | 0.265 | 0.290 | 0.277 |
| event | 11 | 50 | 10 | 0.180 | 0.524 | 0.268 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 2 | 56 | 24 | 0.034 | 0.077 | 0.048 |
...
- missing (10 shown):
  ...
  - gold=('has_participant', 'event', (96,), 'entity', (92, 93, 94, 95), (('sem_role', 'Arg0'),))
  - gold=('has_participant', 'event', (17,), 'entity', (18, 19), (('sem_role', 'Arg1'),))
- spurious (10 shown):
  - predicted=('tlink', 'event', (84,), 'event', (147,), (('reltype', 'BEFORE'),))
...
| relation | 3 | 99 | 18 | 0.029 | 0.143 | 0.049 |
...
| relation | 2 | 32 | 20 | 0.059 | 0.091 | 0.071 |
...
| relation | 1 | 37 | 22 | 0.026 | 0.043 | 0.033 |
