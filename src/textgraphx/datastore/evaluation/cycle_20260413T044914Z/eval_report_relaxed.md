...
- entity: micro F1=0.246 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.299 | entity, event, timex, relation |
| 82738 | 0.313 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 5 | 49 | 12 | 0.093 | 0.294 | 0.141 |
| event | 12 | 38 | 5 | 0.240 | 0.706 | 0.358 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 29 | 20 | 0.033 | 0.048 | 0.039 |

Suggested actions:
- entity: low F1 (0.141) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (25, 26), 'timex', (15,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (230,), 'timex', (225, 226), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (236, 237), 'timex', (225, 226), (('reltype', 'IS_INCLUDED'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 37 | 5 | 0.098 | 0.444 | 0.160 |
| event | 11 | 36 | 4 | 0.234 | 0.733 | 0.355 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 0 | 0 | 22 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.160) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
