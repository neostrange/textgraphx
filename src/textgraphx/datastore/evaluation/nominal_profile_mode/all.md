...
- entity: micro F1=0.103 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.026 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 131 | 9 | 0.058 | 0.471 | 0.103 |
...
- entity: low F1 (0.103) - inspect extraction and matching rules for this layer.
...
- spurious (5 shown):
  ...
  - predicted={'kind': 'entity', 'span': [15], 'attrs': {'syntactic_type': 'NOM'}}
- event:
- missing (5 shown):
