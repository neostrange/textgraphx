...
- entity: micro F1=0.107 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.027 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 124 | 9 | 0.061 | 0.471 | 0.107 |
