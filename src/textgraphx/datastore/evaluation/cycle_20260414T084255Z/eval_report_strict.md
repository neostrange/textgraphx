...
|---|---:|---|
| 82738 | 0.362 | entity, event, timex |
| 76437 | 0.383 | entity, event, timex |
| 61327 | 0.423 | entity, event, timex |
| 112579 | 0.441 | entity, event, timex |
| 96770 | 0.471 | entity, event, timex |
| 62405 | 0.544 | entity, event |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 97 | 14 | 0.030 | 0.176 | 0.051 |
