...
- entity: micro F1=0.265 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.081 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.308 | entity, event, timex, relation |
| 82738 | 0.331 | entity, event, timex, relation |
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (141, 142), 'entity', (139, 140), ())
  - predicted=('has_participant', 'event', (150,), 'entity', (139, 140), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 30 | 7 | 0.211 | 0.533 | 0.302 |
...
- entity: low F1 (0.302) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 23 | 10 | 0.324 | 0.524 | 0.400 |
