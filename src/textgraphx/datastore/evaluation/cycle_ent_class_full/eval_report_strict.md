...
| micro | relaxed | entity | 0.172 | 0.566 | 0.264 |
...
| macro | relaxed | entity | 0.186 | 0.601 | 0.274 |
...
- entity: micro F1=0.176 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.097 | entity, event, timex, relation |
| 76437 | 0.104 | entity, event, timex, relation |
| 61327 | 0.162 | entity, event, timex, relation |
| 112579 | 0.187 | entity, event, timex, relation |
| 96770 | 0.236 | entity, event, timex, relation |
| 62405 | 0.260 | entity, event, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 49 | 6 | 0.125 | 0.538 | 0.203 |
...
- entity: low F1 (0.203) - inspect extraction and matching rules for this layer.
...
- endpoint_mismatch (2 shown):
  ...
  - gold=('has_participant', 'event', (76,), 'entity', (63, 64, 65), (('sem_role', 'Arg1'),)) | predicted=('has_participant', 'event', (76,), 'entity', (64, 65), (('sem_role', 'Arg1'),))
- missing (10 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 67 | 20 | 0.141 | 0.355 | 0.202 |
| event | 1 | 59 | 20 | 0.017 | 0.048 | 0.025 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 2 | 59 | 24 | 0.033 | 0.077 | 0.046 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.202) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- event:
- boundary_mismatch (1 shown):
  - gold={'kind': 'event', 'span': [99, 104], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [104], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'reported', 'time': 'NON_FUTURE'}}
- type_mismatch (8 shown):
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (109,), 'entity', (103, 104), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 79 | 13 | 0.048 | 0.235 | 0.080 |
| event | 0 | 53 | 17 | 0.000 | 0.000 | 0.000 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 5 | 73 | 16 | 0.064 | 0.238 | 0.101 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.080) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- type_mismatch (10 shown):
  ...
  - gold={'kind': 'event', 'span': [26], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'crisis', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [26], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'fell', 'time': 'NON_FUTURE'}}
- missing (5 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 52 | 5 | 0.071 | 0.444 | 0.123 |
...
- event:
- boundary_mismatch (3 shown):
  - gold={'kind': 'event', 'span': [48, 49], 'attrs': {'aspect': 'PERFECTIVE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'know', 'tense': 'PRESENT', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [48], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'crashed', 'tense': 'PRESENT', 'time': 'NON_FUTURE'}}
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (137,), 'entity', (143, 144), (('sem_role', 'Arg2'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 29 | 13 | 0.216 | 0.381 | 0.276 |
| event | 2 | 22 | 18 | 0.083 | 0.100 | 0.091 |
| timex | 3 | 7 | 1 | 0.300 | 0.750 | 0.429 |
| relation | 4 | 27 | 19 | 0.129 | 0.174 | 0.148 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.276) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- entity: type mismatches detected - tune label/attribute mapping in mapping-config.
- event: low F1 (0.091) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
