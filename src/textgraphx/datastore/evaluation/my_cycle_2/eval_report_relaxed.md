...
- entity: micro F1=0.228 below threshold 0.75 - mark as priority optimization track.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (151,), 'entity', (94,), (('sem_role', 'Arg0'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 15 | 64 | 16 | 0.190 | 0.484 | 0.273 |
...
- spurious (9 shown):
  - predicted=('has_participant', 'event', (246,), 'entity', (240, 241, 242, 243, 244), (('sem_role', 'Arg0'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 92 | 10 | 0.071 | 0.412 | 0.121 |
| event | 12 | 53 | 5 | 0.185 | 0.706 | 0.293 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 58 | 20 | 0.017 | 0.048 | 0.025 |

Suggested actions:
- entity: low F1 (0.121) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (210,), 'entity', (211, 212, 213), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (293,), 'entity', (278, 279), (('sem_role', 'Arg0'),))
...
- spurious (9 shown):
  - predicted=('has_participant', 'event', (77,), 'entity', (18, 19, 20), (('sem_role', 'Arg0'),))
