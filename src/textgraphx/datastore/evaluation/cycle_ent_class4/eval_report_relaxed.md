...
- entity: micro F1=0.131 below threshold 0.75 - mark as priority optimization track.
...
| 76437 | 0.230 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 13 | 80 | 4 | 0.140 | 0.765 | 0.236 |
| event | 12 | 45 | 5 | 0.211 | 0.706 | 0.324 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 7 | 85 | 14 | 0.076 | 0.333 | 0.124 |

Suggested actions:
- entity: low F1 (0.236) - inspect extraction and matching rules for this layer.
