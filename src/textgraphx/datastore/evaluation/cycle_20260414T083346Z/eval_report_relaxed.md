...
|---|---:|---|
| 76437 | 0.170 | entity, event, timex, relation |
| 61327 | 0.212 | entity, event, timex, relation |
| 112579 | 0.258 | entity, event, timex, relation |
| 82738 | 0.289 | entity, event, timex, relation |
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (69,), 'entity', (313, 314, 315, 316), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (335,), 'entity', (313, 314, 315, 316), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (167,), 'entity', (160, 161), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (190,), 'entity', (181, 182, 183), (('sem_role', 'Arg0'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 15 | 65 | 16 | 0.188 | 0.484 | 0.270 |
| event | 11 | 64 | 10 | 0.147 | 0.524 | 0.229 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 2 | 31 | 24 | 0.061 | 0.077 | 0.068 |

Suggested actions:
- entity: low F1 (0.270) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
