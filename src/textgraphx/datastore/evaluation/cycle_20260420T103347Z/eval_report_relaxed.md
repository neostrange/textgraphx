...
|---|---:|---|
| 76437 | 0.192 | entity, event, timex, relation |
...
| 96770 | 0.371 | entity, event, timex, relation |
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (183,), 'event', (245,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (332,), 'timex', (292,), (('reltype', 'IS_INCLUDED'),))
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (397,), 'event', (417,), (('reltype', 'BEFORE'),))
