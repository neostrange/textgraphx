...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (256,), 'entity', (253, 254, 255, 256), (('sem_role', 'Arg0'),))
  - predicted=('tlink', 'event', (361,), 'event', (402,), (('reltype', 'BEFORE'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (299,), 'entity', (297, 298), (('sem_role', 'Arg0'),))
  - predicted=('tlink', 'event', (256,), 'event', (299,), (('reltype', 'BEFORE'),))
