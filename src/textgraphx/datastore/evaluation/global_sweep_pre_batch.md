...
- relation: micro F1=0.015 below threshold 0.75 - mark as priority optimization track.
...
- timex: micro F1=0.118 below threshold 0.75 - mark as priority optimization track.
...
| timex | 1 | 12 | 3 | 0.077 | 0.250 | 0.118 |
| relation | 1 | 115 | 20 | 0.009 | 0.048 | 0.015 |
...
- timex:
- type_mismatch (1 shown):
  - gold={'kind': 'timex', 'span': [7, 8, 9, 10], 'attrs': {'functionInDocument': 'CREATION_TIME', 'type': 'DATE', 'value': '2007-08-10'}} | predicted={'kind': 'timex', 'span': [7, 8, 9, 10], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-10'}}
- missing (2 shown):
  - gold={'kind': 'timex', 'span': [38, 39, 40, 41], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-10'}}
  - gold={'kind': 'timex', 'span': [50, 51], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-10'}}
- spurious (10 shown):
  - predicted={'kind': 'timex', 'span': [107], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-09'}}
  - predicted={'kind': 'timex', 'span': [146], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-10'}}
  - predicted={'kind': 'timex', 'span': [168], 'attrs': {'functionInDocument': 'NONE', 'type': 'DATE', 'value': '2007-08-10'}}
- relation:
- type_mismatch (7 shown):
  - gold=('has_participant', 'event', (14,), 'entity', (11, 12, 13), (('sem_role', 'Arg1'),)) | predicted=('has_participant', 'event', (14,), 'entity', (11, 12, 13), (('sem_role', 'ARG1'),))
  - gold=('has_participant', 'event', (2, 3), 'entity', (1,), (('sem_role', 'Arg1'),)) | predicted=('has_participant', 'event', (2, 3), 'entity', (1,), (('sem_role', 'ARG1'),))
  - gold=('has_participant', 'event', (37,), 'entity', (32, 33, 34, 35, 36), (('sem_role', 'Arg1'),)) | predicted=('has_participant', 'event', (37,), 'entity', (32, 33, 34, 35, 36), (('sem_role', 'ARG1'),))
