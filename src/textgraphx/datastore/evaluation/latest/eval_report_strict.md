...
|---|---:|---|
| 82738 | 0.234 | entity, event, timex, relation |
| 61327 | 0.313 | entity, event, timex, relation |
| 76437 | 0.316 | entity, event, timex, relation |
| 112579 | 0.329 | entity, event, timex, relation |
| 96770 | 0.447 | entity, event, timex, relation |
| 62405 | 0.474 | entity, event, relation |
...
| relation | 4 | 0 | 10 | 1.000 | 0.286 | 0.444 |
...
- relation: low F1 (0.444) - inspect extraction and matching rules for this layer.
...
| relation | 3 | 0 | 8 | 1.000 | 0.273 | 0.429 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.429) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
| relation | 5 | 1 | 7 | 0.833 | 0.417 | 0.556 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.556) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| relation | 5 | 0 | 6 | 1.000 | 0.455 | 0.625 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.625) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
| relation | 3 | 1 | 12 | 0.750 | 0.200 | 0.316 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.316) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
| relation | 5 | 0 | 8 | 1.000 | 0.385 | 0.556 |
