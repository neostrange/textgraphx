...
- entity: micro F1=0.342 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.406 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.309 | entity, event, timex, relation |
| 61327 | 0.337 | entity, event, timex, relation |
| 112579 | 0.365 | entity, event, timex, relation |
| 82738 | 0.388 | entity, event, timex, relation |
| 62405 | 0.473 | entity, event, relation |
| 96770 | 0.495 | entity, event, timex, relation |
...
| event | 10 | 40 | 16 | 0.200 | 0.385 | 0.263 |
| timex | 5 | 9 | 1 | 0.357 | 0.833 | 0.500 |
| relation | 4 | 4 | 10 | 0.500 | 0.286 | 0.364 |
...
- relation: low F1 (0.364) - inspect extraction and matching rules for this layer.
...
- spurious (4 shown):
  ...
  - predicted=('tlink', 'event', (36,), 'timex', (12, 13, 14, 15), (('reltype', 'IS_INCLUDED'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 13 | 8 | 0.316 | 0.429 | 0.364 |
| event | 7 | 28 | 5 | 0.200 | 0.583 | 0.298 |
| timex | 2 | 6 | 2 | 0.250 | 0.500 | 0.333 |
| relation | 3 | 3 | 8 | 0.500 | 0.273 | 0.353 |

Suggested actions:
- entity: low F1 (0.364) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.298) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.353) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- spurious (3 shown):
  - predicted=('tlink', 'event', (22,), 'timex', (33,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (22,), 'timex', (7, 8, 9, 10), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (76,), 'timex', (7, 8, 9, 10), (('reltype', 'IS_INCLUDED'),))
...
| event | 11 | 48 | 10 | 0.186 | 0.524 | 0.275 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 6 | 5 | 6 | 0.545 | 0.500 | 0.522 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.522) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (5 shown):
  ...
  - predicted=('tlink', 'event', (52,), 'timex', (8, 9, 10, 11), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (64,), 'timex', (66,), (('reltype', 'IS_INCLUDED'),))
...
| relation | 5 | 4 | 6 | 0.556 | 0.455 | 0.500 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.500) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- spurious (4 shown):
  - predicted=('tlink', 'event', (14,), 'timex', (15,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (14,), 'timex', (7, 8, 9, 10), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (37,), 'timex', (7, 8, 9, 10), (('reltype', 'IS_INCLUDED'),))
...
| event | 12 | 44 | 3 | 0.214 | 0.800 | 0.338 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 3 | 5 | 12 | 0.375 | 0.200 | 0.261 |

Suggested actions:
- entity: low F1 (0.214) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.338) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.261) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- missing (10 shown):
  ...
  - gold=('tlink', 'event', (43,), 'timex', (51, 52), (('reltype', 'IS_INCLUDED'),))
- spurious (5 shown):
  - predicted=('tlink', 'event', (24,), 'timex', (11, 12, 13, 14), (('reltype', 'SIMULTANEOUS'),))
  - predicted=('tlink', 'event', (43,), 'timex', (31, 32, 33), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (57,), 'timex', (11, 12, 13, 14), (('reltype', 'IS_INCLUDED'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 13 | 8 | 6 | 0.619 | 0.684 | 0.650 |
| event | 7 | 16 | 13 | 0.304 | 0.350 | 0.326 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 5 | 5 | 8 | 0.500 | 0.385 | 0.435 |

Suggested actions:
- entity: low F1 (0.650) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.326) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.435) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- spurious (5 shown):
  - predicted=('tlink', 'event', (100,), 'timex', (9, 10, 11, 12), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (15,), 'timex', (21,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (15,), 'timex', (9, 10, 11, 12), (('reltype', 'IS_INCLUDED'),))
