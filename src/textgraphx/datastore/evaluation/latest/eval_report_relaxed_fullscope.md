...
- entity: micro F1=0.340 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.238 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.237 | entity, event, timex, relation |
| 61327 | 0.289 | entity, event, timex, relation |
| 112579 | 0.332 | entity, event, timex, relation |
| 82738 | 0.368 | entity, event, timex, relation |
| 62405 | 0.420 | entity, event, relation |
| 96770 | 0.464 | entity, event, timex, relation |
...
| relation | 5 | 15 | 18 | 0.250 | 0.217 | 0.233 |
...
| relation | 3 | 18 | 13 | 0.143 | 0.188 | 0.162 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.162) - inspect extraction and matching rules for this layer.
...
| relation | 8 | 17 | 18 | 0.320 | 0.308 | 0.314 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.314) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| relation | 5 | 21 | 16 | 0.192 | 0.238 | 0.213 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.213) - inspect extraction and matching rules for this layer.
- relation: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| relation | 4 | 18 | 18 | 0.182 | 0.182 | 0.182 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.182) - inspect extraction and matching rules for this layer.
...
| relation | 6 | 10 | 17 | 0.375 | 0.261 | 0.308 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.308) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
