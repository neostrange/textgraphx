...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.270 | 0.349 | 0.305 |
| micro | strict | event | 0.162 | 0.405 | 0.231 |
| micro | strict | timex | 0.281 | 0.581 | 0.379 |
| micro | strict | relation | 0.267 | 0.214 | 0.237 |
| micro | relaxed | entity | 0.299 | 0.398 | 0.342 |
| micro | relaxed | event | 0.212 | 0.532 | 0.303 |
| micro | relaxed | timex | 0.391 | 0.806 | 0.526 |
| micro | relaxed | relation | 0.238 | 0.237 | 0.238 |
| macro | strict | entity | 0.281 | 0.350 | 0.302 |
| macro | strict | event | 0.168 | 0.425 | 0.233 |
| macro | strict | timex | 0.312 | 0.589 | 0.396 |
| macro | strict | relation | 0.280 | 0.211 | 0.236 |
| macro | relaxed | entity | 0.312 | 0.406 | 0.344 |
| macro | relaxed | event | 0.221 | 0.558 | 0.305 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.244 | 0.232 | 0.235 |

## Relation Kind Breakdown (Micro Strict)

| Relation Kind | Precision | Recall | F1 |
|---|---:|---:|---:|
| has_participant | 0.038 | 0.055 | 0.045 |
| tlink | 0.926 | 0.329 | 0.485 |

## Scorecards

### TimeML Compliance

- Strict Event F1: 0.231
- Strict TIMEX F1: 0.379
- Strict Relation F1: 0.237
- Composite: 0.277
...
- entity: micro F1=0.305 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.237 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.193 | entity, event, timex, relation |
| 76437 | 0.218 | entity, event, timex, relation |
| 61327 | 0.250 | entity, event, timex, relation |
| 112579 | 0.293 | entity, event, timex, relation |
| 96770 | 0.385 | entity, event, timex, relation |
| 62405 | 0.411 | entity, event, relation |
...
| event | 7 | 43 | 19 | 0.140 | 0.269 | 0.184 |
| timex | 4 | 10 | 2 | 0.286 | 0.667 | 0.400 |
| relation | 5 | 11 | 18 | 0.312 | 0.217 | 0.256 |
...
- event: low F1 (0.184) - inspect extraction and matching rules for this layer.
...
- relation: low F1 (0.256) - inspect extraction and matching rules for this layer.
...
- spurious (11 shown):
  - predicted=('has_participant', 'event', (107,), 'entity', (102,), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (167,), 'entity', (166, 167), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (169,), 'entity', (174, 175, 176, 177), (('sem_role', 'Arg2'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 15 | 11 | 0.211 | 0.267 | 0.235 |
| event | 6 | 29 | 6 | 0.171 | 0.500 | 0.255 |
| timex | 2 | 6 | 2 | 0.250 | 0.500 | 0.333 |
| relation | 3 | 15 | 13 | 0.167 | 0.188 | 0.176 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.176) - inspect extraction and matching rules for this layer.
...
- spurious (15 shown):
  - predicted=('has_participant', 'event', (151,), 'entity', (110,), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (151,), 'entity', (134,), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (151,), 'entity', (149,), (('sem_role', 'Arg1'),))
...
| event | 10 | 49 | 11 | 0.169 | 0.476 | 0.250 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 7 | 13 | 19 | 0.350 | 0.269 | 0.304 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.304) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- endpoint_mismatch (1 shown):
  - gold=('tlink', 'event', (84, 85), 'timex', (8, 9, 10, 11), (('reltype', 'IS_INCLUDED'),)) | predicted=('tlink', 'event', (84,), 'timex', (8, 9, 10, 11), (('reltype', 'IS_INCLUDED'),))
- missing (18 shown):
...
- spurious (12 shown):
  ...
  - predicted=('has_participant', 'event', (177,), 'entity', (176, 177), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (177,), 'entity', (179, 180), (('sem_role', 'Arg2'),))
...
| relation | 5 | 17 | 16 | 0.227 | 0.238 | 0.233 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.233) - inspect extraction and matching rules for this layer.
- relation: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| event | 7 | 49 | 8 | 0.125 | 0.467 | 0.197 |
| timex | 2 | 10 | 5 | 0.167 | 0.286 | 0.211 |
| relation | 3 | 15 | 19 | 0.167 | 0.136 | 0.150 |

Suggested actions:
- entity: low F1 (0.214) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- event: low F1 (0.197) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.150) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- relation:
- type_mismatch (2 shown):
  - gold=('has_participant', 'event', (77,), 'entity', (73, 74, 75), (('sem_role', 'Arg0'),)) | predicted=('has_participant', 'event', (77,), 'entity', (73, 74, 75), (('sem_role', 'Arg1'),))
  - gold=('tlink', 'event', (57,), 'timex', (11, 12, 13, 14), (('reltype', 'BEFORE'),)) | predicted=('tlink', 'event', (57,), 'timex', (11, 12, 13, 14), (('reltype', 'IS_INCLUDED'),))
- missing (17 shown):
...
- spurious (13 shown):
  - predicted=('has_participant', 'event', (169,), 'entity', (134,), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (169,), 'entity', (149,), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (169,), 'entity', (164,), (('sem_role', 'Arg2'),))
...
| event | 5 | 18 | 15 | 0.217 | 0.250 | 0.233 |
| timex | 3 | 7 | 1 | 0.300 | 0.750 | 0.429 |
| relation | 5 | 6 | 18 | 0.455 | 0.217 | 0.294 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.585) - inspect extraction and matching rules for this layer.
- entity: recall is weaker than precision - investigate under-generation and missing extractions.
- event: low F1 (0.233) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.294) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
- relation: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- relation:
- type_mismatch (1 shown):
  - gold=('has_participant', 'event', (51,), 'entity', (47, 48, 49, 50), (('sem_role', 'Arg1'),)) | predicted=('has_participant', 'event', (51,), 'entity', (47, 48, 49, 50), (('sem_role', 'Arg0'),))
- missing (17 shown):
...
- spurious (5 shown):
  - predicted=('has_participant', 'event', (120,), 'entity', (109, 110, 111), (('sem_role', 'Arg1'),))
