...
- entity: micro F1=0.194 below threshold 0.75 - mark as priority optimization track.
...
| 76437 | 0.165 | entity, event, timex, relation |
| 61327 | 0.197 | entity, event, timex, relation |
| 112579 | 0.244 | entity, event, timex, relation |
| 96770 | 0.254 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 21 | 12 | 0.125 | 0.200 | 0.154 |
...
- boundary_mismatch (2 shown):
  ...
  - gold={'kind': 'entity', 'span': [127, 128, 129, 130, 131, 132, 133, 134, 135], 'attrs': {}} | predicted={'kind': 'entity', 'span': [135, 136], 'attrs': {'syntactic_type': 'NOM'}}
- missing (20 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 14 | 15 | 0.300 | 0.286 | 0.293 |
