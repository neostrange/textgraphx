...
- entity: micro F1=0.129 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.063 below threshold 0.75 - mark as priority optimization track.
...
| 76437 | 0.229 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 13 | 82 | 4 | 0.137 | 0.765 | 0.232 |
| event | 12 | 45 | 5 | 0.211 | 0.706 | 0.324 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 7 | 85 | 14 | 0.076 | 0.333 | 0.124 |
...
- relation: low F1 (0.124) - inspect extraction and matching rules for this layer.
...
- missing (4 shown):
  ...
  - gold={'kind': 'entity', 'span': [93], 'attrs': {'syntactic_type': 'NOM'}}
- spurious (10 shown):
