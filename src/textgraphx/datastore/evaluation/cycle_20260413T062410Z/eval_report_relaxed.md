...
| 62405 | 0.326 | entity, event, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 21 | 9 | 0.222 | 0.400 | 0.286 |
...
- missing (10 shown):
  ...
  - gold=('has_participant', 'event', (60, 61), 'entity', (58, 59), (('sem_role', 'Arg1'),))
...
- missing (10 shown):
  ...
  - gold=('has_participant', 'event', (51,), 'entity', (47, 48, 49, 50), (('sem_role', 'Arg1'),))
