...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.072 | 0.368 | 0.121 |
| micro | strict | event | 0.162 | 0.405 | 0.232 |
| micro | strict | timex | 0.281 | 0.581 | 0.379 |
| micro | strict | relation | 0.125 | 0.031 | 0.049 |
| micro | relaxed | entity | 0.128 | 0.651 | 0.214 |
| micro | relaxed | event | 0.209 | 0.523 | 0.299 |
| micro | relaxed | timex | 0.391 | 0.806 | 0.526 |
| micro | relaxed | relation | 0.069 | 0.031 | 0.042 |
| macro | strict | entity | 0.078 | 0.372 | 0.126 |
| macro | strict | event | 0.174 | 0.424 | 0.238 |
| macro | strict | timex | 0.312 | 0.589 | 0.396 |
| macro | strict | relation | 0.082 | 0.030 | 0.042 |
| macro | relaxed | entity | 0.141 | 0.659 | 0.225 |
| macro | relaxed | event | 0.226 | 0.545 | 0.307 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.046 | 0.030 | 0.035 |
...
- entity: micro F1=0.121 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.114 | entity, event, timex, relation |
| 76437 | 0.153 | entity, event, timex, relation |
| 61327 | 0.183 | entity, event, timex, relation |
| 112579 | 0.235 | entity, event, timex, relation |
| 96770 | 0.236 | entity, event, timex, relation |
| 62405 | 0.282 | entity, event, relation |
...
- relation: low F1 (0.133) - inspect extraction and matching rules for this layer.
...
- boundary_mismatch (3 shown):
  ...
  - gold={'kind': 'entity', 'span': [89, 90, 91], 'attrs': {'syntactic_type': 'NOM'}} | predicted={'kind': 'entity', 'span': [88, 89, 90, 91], 'attrs': {}}
- missing (2 shown):
...
- spurious (73 shown):
  ...
  - predicted={'kind': 'entity', 'span': [5, 6, 7, 8, 9, 10, 11], 'attrs': {}}
...
- spurious (5 shown):
  ...
  - predicted=('has_participant', 'event', (332,), 'entity', (330, 331), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 63 | 11 | 0.060 | 0.267 | 0.098 |
...
- spurious (59 shown):
  - predicted={'kind': 'entity', 'span': [4, 5, 6], 'attrs': {}}
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 97 | 20 | 0.102 | 0.355 | 0.158 |
| event | 9 | 59 | 12 | 0.132 | 0.429 | 0.202 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 0 | 2 | 26 | 0.000 | 0.000 | 0.000 |
...
- boundary_mismatch (6 shown):
  - gold={'kind': 'entity', 'span': [6, 7], 'attrs': {'syntactic_type': 'NOM'}} | predicted={'kind': 'entity', 'span': [5, 6, 7], 'attrs': {}}
  - gold={'kind': 'entity', 'span': [27, 28], 'attrs': {'syntactic_type': 'PRE.NOM'}} | predicted={'kind': 'entity', 'span': [27, 28, 29], 'attrs': {'syntactic_type': 'NOM'}}
  - gold={'kind': 'entity', 'span': [38, 39, 40, 41, 42], 'attrs': {'syntactic_type': 'NOM'}} | predicted={'kind': 'entity', 'span': [37, 38, 39, 40, 41, 42], 'attrs': {}}
- type_mismatch (2 shown):
  - gold={'kind': 'entity', 'span': [18, 19], 'attrs': {'syntactic_type': 'NOM'}} | predicted={'kind': 'entity', 'span': [18, 19], 'attrs': {}}
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 112 | 13 | 0.034 | 0.235 | 0.060 |
| event | 10 | 49 | 7 | 0.169 | 0.588 | 0.263 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 15 | 20 | 0.062 | 0.048 | 0.054 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.060) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- entity: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.054) - inspect extraction and matching rules for this layer.
- relation: recall is weaker than precision - investigate under-generation and missing extractions.
...
- spurious (108 shown):
  - predicted={'kind': 'entity', 'span': [3], 'attrs': {}}
  - predicted={'kind': 'entity', 'span': [4, 5, 6], 'attrs': {}}
  - predicted={'kind': 'entity', 'span': [7], 'attrs': {'syntactic_type': 'NAM'}}
- event:
...
- spurious (15 shown):
  - predicted=('has_participant', 'event', (370,), 'entity', (365,), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 100 | 6 | 0.029 | 0.333 | 0.054 |
...
Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.054) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- entity: type mismatches detected - tune label/attribute mapping in mapping-config.
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
...
- type_mismatch (2 shown):
  - gold={'kind': 'entity', 'span': [15], 'attrs': {'syntactic_type': 'HLS'}} | predicted={'kind': 'entity', 'span': [15], 'attrs': {'syntactic_type': 'PRO'}}
  - gold={'kind': 'entity', 'span': [58, 59], 'attrs': {'syntactic_type': 'NOM'}} | predicted={'kind': 'entity', 'span': [58, 59], 'attrs': {}}
- missing (3 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 51 | 12 | 0.150 | 0.429 | 0.222 |
| event | 5 | 19 | 15 | 0.208 | 0.250 | 0.227 |
| timex | 3 | 7 | 1 | 0.300 | 0.750 | 0.429 |
| relation | 1 | 6 | 22 | 0.143 | 0.043 | 0.067 |
...
- spurious (42 shown):
  ...
  - predicted={'kind': 'entity', 'span': [16], 'attrs': {}}
  - predicted={'kind': 'entity', 'span': [21], 'attrs': {'syntactic_type': 'NAM'}}
- event:
- type_mismatch (2 shown):
