...
- entity: micro F1=0.214 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.177 | entity, event, timex, relation |
| 61327 | 0.220 | entity, event, timex, relation |
| 82738 | 0.286 | entity, event, timex, relation |
| 112579 | 0.294 | entity, event, timex, relation |
| 62405 | 0.313 | entity, event, relation |
| 96770 | 0.347 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 73 | 2 | 0.131 | 0.846 | 0.227 |
| event | 11 | 29 | 15 | 0.275 | 0.423 | 0.333 |
| timex | 5 | 9 | 1 | 0.357 | 0.833 | 0.500 |
| relation | 2 | 10 | 21 | 0.167 | 0.087 | 0.114 |
...
- relation: low F1 (0.114) - inspect extraction and matching rules for this layer.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 59 | 7 | 0.119 | 0.533 | 0.195 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 18 | 90 | 13 | 0.167 | 0.581 | 0.259 |
| event | 10 | 58 | 11 | 0.147 | 0.476 | 0.225 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 0 | 2 | 26 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.259) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 108 | 9 | 0.069 | 0.471 | 0.120 |
| event | 12 | 47 | 5 | 0.203 | 0.706 | 0.316 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 30 | 20 | 0.032 | 0.048 | 0.038 |

Suggested actions:
- entity: low F1 (0.120) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.316) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.038) - inspect extraction and matching rules for this layer.
...
- missing (10 shown):
  ...
  - gold=('has_participant', 'event', (37,), 'entity', (32, 33, 34, 35, 36), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 97 | 3 | 0.058 | 0.667 | 0.107 |
| event | 11 | 47 | 4 | 0.190 | 0.733 | 0.301 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 0 | 0 | 22 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.107) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 18 | 42 | 3 | 0.300 | 0.857 | 0.444 |
| event | 7 | 17 | 13 | 0.292 | 0.350 | 0.318 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 1 | 12 | 22 | 0.077 | 0.043 | 0.056 |

Suggested actions:
- entity: low F1 (0.444) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
