...
- entity: micro F1=0.257 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.214 | entity, event, timex, relation |
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (109,), 'entity', (103, 104), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 79 | 8 | 0.102 | 0.529 | 0.171 |
| event | 12 | 39 | 5 | 0.235 | 0.706 | 0.353 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 5 | 77 | 16 | 0.061 | 0.238 | 0.097 |

Suggested actions:
- entity: low F1 (0.171) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
