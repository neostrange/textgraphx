...
|---|---:|---|
| 76437 | 0.178 | entity, event, timex, relation |
| 61327 | 0.220 | entity, event, timex, relation |
| 82738 | 0.287 | entity, event, timex, relation |
| 112579 | 0.295 | entity, event, timex, relation |
| 62405 | 0.311 | entity, event, relation |
| 96770 | 0.349 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 71 | 2 | 0.134 | 0.846 | 0.232 |
| event | 11 | 29 | 15 | 0.275 | 0.423 | 0.333 |
| timex | 5 | 9 | 1 | 0.357 | 0.833 | 0.500 |
| relation | 2 | 10 | 21 | 0.167 | 0.087 | 0.114 |

Suggested actions:
- entity: low F1 (0.232) - inspect extraction and matching rules for this layer.
...
- missing (10 shown):
  ...
  - gold=('has_participant', 'event', (87,), 'entity', (89, 90, 91), (('sem_role', 'Arg1'),))
...
- relation:
- missing (10 shown):
  - gold=('tlink', 'event', (53,), 'event', (58,), (('reltype', 'AFTER'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 17 | 87 | 14 | 0.163 | 0.548 | 0.252 |
| event | 10 | 58 | 11 | 0.147 | 0.476 | 0.225 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 0 | 2 | 26 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.252) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- missing (10 shown):
  ...
  - gold=('tlink', 'event', (52,), 'timex', (8, 9, 10, 11), (('reltype', 'IS_INCLUDED'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 94 | 3 | 0.060 | 0.667 | 0.110 |
| event | 11 | 47 | 4 | 0.190 | 0.733 | 0.301 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 0 | 0 | 22 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.110) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 18 | 41 | 3 | 0.305 | 0.857 | 0.450 |
| event | 7 | 17 | 13 | 0.292 | 0.350 | 0.318 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 1 | 12 | 22 | 0.077 | 0.043 | 0.056 |

Suggested actions:
- entity: low F1 (0.450) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
