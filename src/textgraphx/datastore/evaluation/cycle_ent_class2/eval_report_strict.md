...
- entity: micro F1=0.079 below threshold 0.75 - mark as priority optimization track.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 65 | 10 | 0.097 | 0.412 | 0.157 |
...
- entity: low F1 (0.157) - inspect extraction and matching rules for this layer.
