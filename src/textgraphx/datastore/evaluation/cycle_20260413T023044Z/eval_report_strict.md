...
| micro | relaxed | entity | 0.177 | 0.585 | 0.272 |
...
| macro | relaxed | entity | 0.193 | 0.621 | 0.283 |
...
| 96770 | 0.282 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 44 | 6 | 0.137 | 0.538 | 0.219 |
...
- entity: low F1 (0.219) - inspect extraction and matching rules for this layer.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 26 | 13 | 0.235 | 0.381 | 0.291 |
