...
| macro | relaxed | entity | 0.191 | 0.621 | 0.280 |
...
|---|---:|---|
| 76437 | 0.223 | entity, event, timex, relation |
| 61327 | 0.240 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 32 | 6 | 0.220 | 0.600 | 0.321 |
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141, 142, 143), 'entity', (139,), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 79 | 6 | 0.122 | 0.647 | 0.206 |
