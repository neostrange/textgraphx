...
- relation: micro F1=0.067 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.301 | entity, event, timex, relation |
| 82738 | 0.347 | entity, event, timex, relation |
| 62405 | 0.372 | entity, event, relation |
...
| relation | 3 | 53 | 20 | 0.054 | 0.130 | 0.076 |
...
| relation | 1 | 41 | 15 | 0.024 | 0.062 | 0.034 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.034) - inspect extraction and matching rules for this layer.
- relation: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| relation | 4 | 41 | 22 | 0.089 | 0.154 | 0.113 |
...
| relation | 3 | 98 | 18 | 0.030 | 0.143 | 0.049 |
