...
- entity: micro F1=0.263 below threshold 0.75 - mark as priority optimization track.
...
| 96770 | 0.350 | entity, event, timex, relation |
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141,), 'entity', (139,), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 54 | 2 | 0.115 | 0.778 | 0.200 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 27 | 10 | 0.289 | 0.524 | 0.373 |
| event | 7 | 18 | 13 | 0.280 | 0.350 | 0.311 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 4 | 29 | 19 | 0.121 | 0.174 | 0.143 |

Suggested actions:
- entity: low F1 (0.373) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.311) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
