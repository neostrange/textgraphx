"""Utilities for confidence and provenance on inferred graph relationships."""

from __future__ import annotations

from typing import Any, Dict, Optional

from textgraphx.reasoning.authority import normalize_evidence_source, resolve_authority_tier
...
def stamp_inferred_relationships(
    ...
    """Stamp provenance or confidence properties on inferred relationships."""
