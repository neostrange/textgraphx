...
def test_temporal_provenance_contract_fails_when_missing_fields():
    ...
    with patch("textgraphx.pipeline.runtime.phase_assertions.validate_inferred_relationship_provenance", return_value=2):
...
def test_event_enrichment_provenance_contract_passes_when_complete():
    ...
    with patch("textgraphx.pipeline.runtime.phase_assertions.validate_inferred_relationship_provenance", return_value=0):
