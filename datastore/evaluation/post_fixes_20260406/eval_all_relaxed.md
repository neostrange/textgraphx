...
- relation: micro F1=0.122 below threshold 0.50 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.122 | entity, event, timex, relation |
...
| relation | 7 | 87 | 14 | 0.074 | 0.333 | 0.122 |
...
- relation: low F1 (0.122) - inspect extraction and matching rules for this layer.
