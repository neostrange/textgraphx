...
- entity: micro F1=0.092 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.023 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 45 | 14 | 0.062 | 0.176 | 0.092 |
...
- spurious (5 shown):
  ...
  - predicted={'kind': 'entity', 'span': [44, 45, 46], 'attrs': {'syntactic_type': 'OTHER'}}
  - predicted={'kind': 'entity', 'span': [53, 54], 'attrs': {'syntactic_type': 'OTHER'}}
- event:
- missing (5 shown):
