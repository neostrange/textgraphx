...
- entity: micro F1=0.133 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.033 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 95 | 9 | 0.078 | 0.471 | 0.133 |
