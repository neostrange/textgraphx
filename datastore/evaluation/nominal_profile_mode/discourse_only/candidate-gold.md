...
- entity: micro F1=0.150 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.037 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 82 | 9 | 0.089 | 0.471 | 0.150 |
...
- entity: low F1 (0.150) - inspect extraction and matching rules for this layer.
