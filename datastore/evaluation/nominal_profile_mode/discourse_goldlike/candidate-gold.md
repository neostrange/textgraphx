...
- entity: micro F1=0.139 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.035 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 90 | 9 | 0.082 | 0.471 | 0.139 |
...
- entity: low F1 (0.139) - inspect extraction and matching rules for this layer.
