...
class ExecutionHistory:
    ...
    def store_execution(self, record: ExecutionRecord) -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                conn.commit()
            logger.info(f"Stored execution record: {record.execution_id}")
            return True
    ...
    def get_execution(self, execution_id: str) -> Optional[ExecutionRecord]:
        ...
        try:
            ...
            logger.error(f"Failed to retrieve execution: {e}")
        return None
    ...
    def get_by_dataset(self, dataset_path: str, limit: int = 50) -> List[ExecutionRecord]:
        ...
        try:
            ...
            logger.error(f"Failed to retrieve dataset history: {e}")
        return []
...
if __name__ == "__main__":
    ...
    record = ExecutionRecord(
        ...
        status="success",
        total_duration=24.5,
        phase_timings={"ingestion": 16.2, "refinement": 8.3},
        documents_processed=15,
    )
    
    history.store_execution(record)
    
    # Retrieve and display
    retrieved = history.get_execution("test-001")
    if retrieved:
