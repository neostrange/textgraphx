...
- entity: micro F1=0.270 below threshold 0.75 - mark as priority optimization track.
- event: dataset-level precision gap - tighten confidence filters and post-processing constraints.
- event: micro F1=0.302 below threshold 0.75 - mark as priority optimization track.
- relation: dataset-level precision gap - tighten confidence filters and post-processing constraints.
- relation: micro F1=0.076 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.219 | entity, event, timex, relation |
| 61327 | 0.262 | entity, event, timex, relation |
| 112579 | 0.284 | entity, event, timex, relation |
| 82738 | 0.328 | entity, event, timex, relation |
| 62405 | 0.330 | entity, event, relation |
| 96770 | 0.359 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 47 | 4 | 0.161 | 0.692 | 0.261 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 10 | 30 | 5 | 0.250 | 0.667 | 0.364 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 15 | 62 | 16 | 0.195 | 0.484 | 0.278 |
| event | 9 | 50 | 12 | 0.153 | 0.429 | 0.225 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 2 | 58 | 24 | 0.033 | 0.077 | 0.047 |

Suggested actions:
- entity: low F1 (0.278) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 10 | 75 | 7 | 0.118 | 0.588 | 0.196 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 25 | 10 | 0.306 | 0.524 | 0.386 |
| event | 7 | 16 | 13 | 0.304 | 0.350 | 0.326 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 4 | 25 | 19 | 0.138 | 0.174 | 0.154 |

Suggested actions:
- entity: low F1 (0.386) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
