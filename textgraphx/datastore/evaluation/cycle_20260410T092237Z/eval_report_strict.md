...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.117 | 0.387 | 0.179 |
| micro | strict | event | 0.086 | 0.216 | 0.123 |
| micro | strict | timex | 0.266 | 0.548 | 0.358 |
| micro | strict | relation | 0.055 | 0.122 | 0.075 |
| micro | relaxed | entity | 0.174 | 0.575 | 0.267 |
| micro | relaxed | event | 0.211 | 0.532 | 0.302 |
| micro | relaxed | timex | 0.391 | 0.806 | 0.526 |
| micro | relaxed | relation | 0.055 | 0.122 | 0.076 |
| macro | strict | entity | 0.129 | 0.402 | 0.188 |
| macro | strict | event | 0.092 | 0.214 | 0.125 |
| macro | strict | timex | 0.300 | 0.562 | 0.379 |
| macro | strict | relation | 0.060 | 0.121 | 0.077 |
| macro | relaxed | entity | 0.189 | 0.611 | 0.278 |
| macro | relaxed | event | 0.220 | 0.560 | 0.305 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.060 | 0.121 | 0.077 |
...
- Event Gain (relaxed - strict): 0.179
...
- entity: micro F1=0.179 below threshold 0.75 - mark as priority optimization track.
...
- event: micro F1=0.123 below threshold 0.75 - mark as priority optimization track.
...
| 61327 | 0.184 | entity, event, timex, relation |
| 112579 | 0.200 | entity, event, timex, relation |
| 96770 | 0.251 | entity, event, timex, relation |
| 62405 | 0.274 | entity, event, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 32 | 9 | 0.158 | 0.400 | 0.226 |
...
Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.226) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- type_mismatch (4 shown):
  ...
  - gold={'kind': 'event', 'span': [50], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'attacks', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [50], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'follow', 'time': 'NON_FUTURE'}}
...
| event | 3 | 56 | 18 | 0.051 | 0.143 | 0.075 |
...
- event: low F1 (0.075) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- event:
- boundary_mismatch (1 shown):
  - gold={'kind': 'event', 'span': [99, 104], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [104], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'report', 'time': 'NON_FUTURE'}}
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 5 | 80 | 12 | 0.059 | 0.294 | 0.098 |
...
Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.098) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| event | 3 | 57 | 12 | 0.050 | 0.200 | 0.080 |
| timex | 2 | 10 | 5 | 0.167 | 0.286 | 0.211 |
| relation | 1 | 54 | 21 | 0.018 | 0.045 | 0.026 |
...
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- event: low F1 (0.080) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- spurious (10 shown):
  - predicted={'kind': 'event', 'span': [42], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'mark', 'time': 'NON_FUTURE'}}
  - predicted={'kind': 'event', 'span': [59], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'send', 'time': 'NON_FUTURE'}}
  - predicted={'kind': 'event', 'span': [82], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'break', 'time': 'NON_FUTURE'}}
- timex:
- boundary_mismatch (2 shown):
...
| event | 3 | 20 | 17 | 0.130 | 0.150 | 0.140 |
| timex | 3 | 7 | 1 | 0.300 | 0.750 | 0.429 |
| relation | 4 | 25 | 19 | 0.138 | 0.174 | 0.154 |
