...
- entity: micro F1=0.127 below threshold 0.75 - mark as priority optimization track.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 14 | 100 | 3 | 0.123 | 0.824 | 0.214 |
