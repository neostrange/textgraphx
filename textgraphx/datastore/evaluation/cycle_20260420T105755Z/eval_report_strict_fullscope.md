...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.189 | 0.340 | 0.243 |
| micro | strict | event | 0.161 | 0.414 | 0.232 |
| micro | strict | timex | 0.281 | 0.581 | 0.379 |
| micro | strict | relation | 0.055 | 0.076 | 0.064 |
| micro | relaxed | entity | 0.221 | 0.408 | 0.287 |
| micro | relaxed | event | 0.211 | 0.541 | 0.303 |
| micro | relaxed | timex | 0.391 | 0.806 | 0.526 |
| micro | relaxed | relation | 0.029 | 0.076 | 0.042 |
| macro | strict | entity | 0.207 | 0.337 | 0.246 |
| macro | strict | event | 0.167 | 0.431 | 0.233 |
| macro | strict | timex | 0.312 | 0.589 | 0.396 |
| macro | strict | relation | 0.056 | 0.074 | 0.061 |
| macro | relaxed | entity | 0.243 | 0.420 | 0.297 |
| macro | relaxed | event | 0.218 | 0.564 | 0.305 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.029 | 0.074 | 0.040 |
...
- entity: micro F1=0.243 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.064 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.160 | entity, event, timex, relation |
| 76437 | 0.174 | entity, event, timex, relation |
| 61327 | 0.197 | entity, event, timex, relation |
| 112579 | 0.225 | entity, event, timex, relation |
| 96770 | 0.309 | entity, event, timex, relation |
...
| relation | 2 | 38 | 21 | 0.050 | 0.087 | 0.063 |
...
- spurious (38 shown):
  ...
  - predicted=('has_participant', 'event', (327,), 'entity', (330, 331), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 21 | 11 | 0.160 | 0.267 | 0.200 |
| event | 6 | 29 | 6 | 0.171 | 0.500 | 0.255 |
| timex | 2 | 6 | 2 | 0.250 | 0.500 | 0.333 |
| relation | 0 | 22 | 16 | 0.000 | 0.000 | 0.000 |
...
| relation | 2 | 30 | 24 | 0.062 | 0.077 | 0.069 |
...
- spurious (29 shown):
  ...
  - predicted=('has_participant', 'event', (190,), 'entity', (187,), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (193,), 'entity', (187,), (('sem_role', 'Arg0'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 37 | 14 | 0.075 | 0.176 | 0.105 |
| event | 10 | 46 | 7 | 0.179 | 0.588 | 0.274 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 3 | 48 | 18 | 0.059 | 0.143 | 0.083 |

Suggested actions:
- entity: low F1 (0.105) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.083) - inspect extraction and matching rules for this layer.
- relation: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: type mismatches detected - tune label/attribute mapping in mapping-config.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 32 | 6 | 0.086 | 0.333 | 0.136 |
| event | 7 | 51 | 8 | 0.121 | 0.467 | 0.192 |
| timex | 2 | 10 | 5 | 0.167 | 0.286 | 0.211 |
| relation | 2 | 15 | 20 | 0.118 | 0.091 | 0.103 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 12 | 12 | 9 | 0.500 | 0.571 | 0.533 |
...
Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.533) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
