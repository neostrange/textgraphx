...
- entity: micro F1=0.215 below threshold 0.75 - mark as priority optimization track.
...
| 61327 | 0.221 | entity, event, timex, relation |
| 82738 | 0.282 | entity, event, timex, relation |
| 112579 | 0.294 | entity, event, timex, relation |
| 62405 | 0.314 | entity, event, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 72 | 2 | 0.133 | 0.846 | 0.229 |
| event | 11 | 29 | 15 | 0.275 | 0.423 | 0.333 |
| timex | 5 | 9 | 1 | 0.357 | 0.833 | 0.500 |
| relation | 2 | 10 | 21 | 0.167 | 0.087 | 0.114 |

Suggested actions:
- entity: low F1 (0.229) - inspect extraction and matching rules for this layer.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 57 | 7 | 0.123 | 0.533 | 0.200 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 18 | 88 | 13 | 0.170 | 0.581 | 0.263 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 5 | 95 | 4 | 0.050 | 0.556 | 0.092 |
