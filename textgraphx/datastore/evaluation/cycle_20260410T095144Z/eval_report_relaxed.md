...
| macro | relaxed | entity | 0.187 | 0.621 | 0.276 |
...
- entity: micro F1=0.266 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.216 | entity, event, timex, relation |
| 61327 | 0.231 | entity, event, timex, relation |
| 112579 | 0.289 | entity, event, timex, relation |
| 82738 | 0.324 | entity, event, timex, relation |
| 62405 | 0.345 | entity, event, relation |
...
| relation | 3 | 38 | 20 | 0.073 | 0.130 | 0.094 |
...
| event | 5 | 29 | 7 | 0.147 | 0.417 | 0.217 |
...
- event: low F1 (0.217) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141, 142, 143), 'entity', (137,), ())
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (109,), 'entity', (107, 108), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 81 | 6 | 0.120 | 0.647 | 0.202 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 55 | 2 | 0.113 | 0.778 | 0.197 |
| event | 12 | 45 | 3 | 0.211 | 0.800 | 0.333 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 1 | 48 | 21 | 0.020 | 0.045 | 0.028 |

Suggested actions:
- entity: low F1 (0.197) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.333) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (108,), 'entity', (105, 106, 107), ())
