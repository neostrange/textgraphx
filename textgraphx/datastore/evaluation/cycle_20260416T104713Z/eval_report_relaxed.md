...
| micro | relaxed | entity | 0.146 | 0.585 | 0.234 |
...
| 82738 | 0.302 | entity, event, timex, relation |
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (134,), 'event', (151,), (('reltype', ''),))
  - predicted=('tlink', 'event', (211,), 'event', (239,), (('reltype', 'BEFORE'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 16 | 60 | 15 | 0.211 | 0.516 | 0.299 |
| event | 11 | 50 | 10 | 0.180 | 0.524 | 0.268 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 1 | 57 | 11 | 0.017 | 0.083 | 0.029 |

Suggested actions:
- entity: low F1 (0.299) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (17,), 'event', (50,), (('reltype', 'BEFORE'),))
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (309,), 'event', (311,), (('reltype', 'BEFORE'),))
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (187,), 'event', (191,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (187,), 'event', (191,), (('reltype', 'BEFORE'),))
