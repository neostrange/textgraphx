...
- entity: micro F1=0.285 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.043 below threshold 0.75 - mark as priority optimization track.
...
| 82738 | 0.308 | entity, event, timex, relation |
| 62405 | 0.328 | entity, event, relation |
| 96770 | 0.407 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 25 | 9 | 0.138 | 0.308 | 0.190 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 5 | 19 | 10 | 0.208 | 0.333 | 0.256 |
...
- spurious (19 shown):
  ...
  - predicted={'kind': 'entity', 'span': [86, 87], 'attrs': {}}
...
| relation | 0 | 1 | 26 | 0.000 | 0.000 | 0.000 |
...
- spurious (1 shown):
  - predicted=('has_participant', 'event', (188,), 'entity', (187, 188), (('sem_role', 'Arg0'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 36 | 14 | 0.077 | 0.176 | 0.107 |
...
- spurious (36 shown):
  ...
  - predicted={'kind': 'entity', 'span': [139, 140], 'attrs': {'syntactic_type': 'PRO'}}
- event:
- missing (5 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 28 | 5 | 0.125 | 0.444 | 0.195 |
...
- spurious (28 shown):
  ...
  - predicted={'kind': 'entity', 'span': [23, 24], 'attrs': {}}
- event:
- missing (4 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 14 | 6 | 7 | 0.700 | 0.667 | 0.683 |
