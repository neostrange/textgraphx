...
- entity: micro F1=0.276 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.019 below threshold 0.75 - mark as priority optimization track.
...
| 61327 | 0.229 | entity, event, timex, relation |
| 112579 | 0.266 | entity, event, timex, relation |
| 82738 | 0.315 | entity, event, timex, relation |
| 62405 | 0.340 | entity, event, relation |
| 96770 | 0.357 | entity, event, timex, relation |
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (183,), 'event', (262,), (('reltype', 'BEFORE'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 33 | 7 | 0.195 | 0.533 | 0.286 |
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (22,), 'event', (54,), (('reltype', 'BEFORE'),))
...
| relation | 1 | 57 | 11 | 0.017 | 0.083 | 0.029 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.029) - inspect extraction and matching rules for this layer.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| relation | 1 | 54 | 10 | 0.018 | 0.091 | 0.030 |
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (113,), 'event', (224,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (224,), 'event', (256,), (('reltype', 'AFTER'),))
  - predicted=('tlink', 'event', (256,), 'event', (293,), (('reltype', 'BEFORE'),))
...
| relation | 1 | 28 | 14 | 0.034 | 0.067 | 0.045 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 18 | 28 | 3 | 0.391 | 0.857 | 0.537 |
| event | 7 | 17 | 13 | 0.292 | 0.350 | 0.318 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 0 | 25 | 13 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.537) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (180,), 'event', (229,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (142,), 'event', (229,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (51,), 'event', (76,), (('reltype', 'BEFORE'),))
