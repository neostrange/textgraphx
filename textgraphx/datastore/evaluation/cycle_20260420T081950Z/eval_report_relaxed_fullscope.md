...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (332,), 'timex', (334,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('has_participant', 'event', (344,), 'entity', (174, 175, 176, 177), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (45,), 'timex', (33,), (('reltype', 'ENDED_BY'),))
  - predicted=('has_participant', 'event', (233,), 'entity', (232,), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (245,), 'entity', (232,), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (233,), 'entity', (202, 203, 204, 205), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (224,), 'event', (256,), (('reltype', 'AFTER'),))
  - predicted=('tlink', 'event', (293,), 'event', (299,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (192,), 'event', (194,), (('reltype', 'BEFORE'),))
...
- relation:
- missing (10 shown):
  - gold=('has_participant', 'event', (65,), 'entity', (58, 59), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (229,), 'timex', (231,), (('reltype', 'IS_INCLUDED'),))
