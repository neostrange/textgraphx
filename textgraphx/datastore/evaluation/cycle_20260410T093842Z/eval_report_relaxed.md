...
- entity: micro F1=0.267 below threshold 0.75 - mark as priority optimization track.
- event: dataset-level precision gap - tighten confidence filters and post-processing constraints.
- event: micro F1=0.307 below threshold 0.75 - mark as priority optimization track.
...
| 61327 | 0.255 | entity, event, timex, relation |
| 112579 | 0.286 | entity, event, timex, relation |
| 82738 | 0.333 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 30 | 6 | 0.231 | 0.600 | 0.333 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 50 | 2 | 0.123 | 0.778 | 0.212 |
| event | 13 | 45 | 2 | 0.224 | 0.867 | 0.356 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 1 | 52 | 21 | 0.019 | 0.045 | 0.027 |

Suggested actions:
- entity: low F1 (0.212) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
