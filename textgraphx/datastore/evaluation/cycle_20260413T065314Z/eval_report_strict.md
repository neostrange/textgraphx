...
- entity: micro F1=0.216 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.129 | entity, event, timex, relation |
| 82738 | 0.147 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 30 | 6 | 0.091 | 0.333 | 0.143 |
