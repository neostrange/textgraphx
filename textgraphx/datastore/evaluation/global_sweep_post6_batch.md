...
- relation: micro F1=0.117 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.197 | entity, event, timex, relation |
...
| relation | 7 | 92 | 14 | 0.071 | 0.333 | 0.117 |
...
- relation: low F1 (0.117) - inspect extraction and matching rules for this layer.
