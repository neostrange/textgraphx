...
- entity: micro F1=0.142 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.122 | entity, event, timex, relation |
| 76437 | 0.142 | entity, event, timex, relation |
| 61327 | 0.173 | entity, event, timex, relation |
| 112579 | 0.203 | entity, event, timex, relation |
| 96770 | 0.234 | entity, event, timex, relation |
| 62405 | 0.312 | entity, event, relation |
...
| relation | 3 | 94 | 20 | 0.031 | 0.130 | 0.050 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 96 | 13 | 0.040 | 0.235 | 0.068 |
| event | 10 | 55 | 7 | 0.154 | 0.588 | 0.244 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 68 | 20 | 0.014 | 0.048 | 0.022 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.068) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- entity: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
- relation: low F1 (0.022) - inspect extraction and matching rules for this layer.
- relation: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (26 shown):
  ...
  - predicted=('has_participant', 'event', (115,), 'entity', (103,), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (122,), 'entity', (103,), (('sem_role', 'Arg1'),))
...
| relation | 1 | 13 | 22 | 0.071 | 0.043 | 0.054 |
