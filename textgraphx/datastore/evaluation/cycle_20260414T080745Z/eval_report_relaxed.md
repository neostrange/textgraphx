...
- entity: micro F1=0.232 below threshold 0.75 - mark as priority optimization track.
...
| 62405 | 0.335 | entity, event, relation |
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (337,), 'entity', (313, 314, 315, 316), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (168,), 'entity', (157, 158), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (197,), 'entity', (181, 182, 183), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (249,), 'entity', (240, 241, 242, 243, 244), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (50,), 'entity', (53, 54), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (244,), 'entity', (240, 241, 242, 243, 244), (('sem_role', 'Arg0'),))
...
| relation | 1 | 87 | 20 | 0.011 | 0.048 | 0.018 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.018) - inspect extraction and matching rules for this layer.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (299,), 'entity', (282, 283), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (198,), 'entity', (181, 182), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (83,), 'entity', (18, 19, 20), (('sem_role', 'Arg0'),))
