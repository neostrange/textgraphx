...
- relation: micro F1=0.032 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.263 | entity, event, timex, relation |
| 82738 | 0.280 | entity, event, timex, relation |
| 62405 | 0.322 | entity, event, relation |
...
| relation | 2 | 33 | 21 | 0.057 | 0.087 | 0.069 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 16 | 64 | 15 | 0.200 | 0.516 | 0.288 |
| event | 11 | 64 | 10 | 0.147 | 0.524 | 0.229 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 0 | 10 | 26 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.288) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (193,), 'entity', (184,), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (402,), 'entity', (401,), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (407,), 'entity', (401,), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 93 | 9 | 0.079 | 0.471 | 0.136 |
| event | 12 | 53 | 5 | 0.185 | 0.706 | 0.293 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 48 | 20 | 0.020 | 0.048 | 0.029 |
...
| relation | 1 | 15 | 22 | 0.062 | 0.043 | 0.051 |
