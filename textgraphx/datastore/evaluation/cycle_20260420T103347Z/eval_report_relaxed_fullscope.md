...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.128 | 0.415 | 0.196 |
...
| macro | strict | entity | 0.138 | 0.408 | 0.202 |
...
- spurious (10 shown):
  ...
  - predicted=('tlink', 'event', (198,), 'event', (203,), (('reltype', 'AFTER'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (177,), 'entity', (157, 158), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (249,), 'entity', (232,), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (241,), 'entity', (235, 236, 237, 238, 239), (('sem_role', 'Arg0'),))
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (246,), 'event', (249,), (('reltype', 'BEFORE'),))
  - predicted=('has_participant', 'event', (167,), 'entity', (171, 172), (('sem_role', 'Arg0'),))
  - predicted=('tlink', 'event', (96,), 'event', (147,), (('reltype', 'BEFORE'),))
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (198,), 'entity', (181, 182), (('sem_role', 'Arg0'),))
  - predicted=('tlink', 'event', (122,), 'event', (124,), (('reltype', 'BEFORE'),))
  - predicted=('tlink', 'event', (216,), 'timex', (213,), (('reltype', 'IS_INCLUDED'),))
