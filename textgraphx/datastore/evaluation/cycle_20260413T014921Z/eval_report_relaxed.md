...
| micro | relaxed | entity | 0.174 | 0.585 | 0.268 |
...
| macro | relaxed | entity | 0.190 | 0.621 | 0.279 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 29 | 6 | 0.237 | 0.600 | 0.340 |
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141, 142, 143), 'entity', (135,), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 78 | 6 | 0.124 | 0.647 | 0.208 |
