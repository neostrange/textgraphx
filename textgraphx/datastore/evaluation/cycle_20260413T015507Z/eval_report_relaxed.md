...
| 112579 | 0.307 | entity, event, timex, relation |
| 82738 | 0.330 | entity, event, timex, relation |
| 62405 | 0.342 | entity, event, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 44 | 4 | 0.170 | 0.692 | 0.273 |
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141, 142, 143), 'entity', (132,), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 15 | 58 | 16 | 0.205 | 0.484 | 0.288 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 10 | 81 | 7 | 0.110 | 0.588 | 0.185 |
| event | 12 | 39 | 5 | 0.235 | 0.706 | 0.353 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 5 | 77 | 16 | 0.061 | 0.238 | 0.097 |

Suggested actions:
- entity: low F1 (0.185) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
