...
- entity: micro F1=0.070 below threshold 0.75 - mark as priority optimization track.
...
| 76437 | 0.196 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 86 | 10 | 0.075 | 0.412 | 0.127 |
...
- entity: low F1 (0.127) - inspect extraction and matching rules for this layer.
