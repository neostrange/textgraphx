...
- entity: micro F1=0.271 below threshold 0.75 - mark as priority optimization track.
...
| 61327 | 0.266 | entity, event, timex, relation |
| 112579 | 0.286 | entity, event, timex, relation |
| 82738 | 0.327 | entity, event, timex, relation |
| 62405 | 0.331 | entity, event, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 45 | 4 | 0.167 | 0.692 | 0.269 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 10 | 28 | 5 | 0.263 | 0.667 | 0.377 |
...
- entity: low F1 (0.377) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- endpoint_mismatch (2 shown):
  ...
  - gold=('has_participant', 'event', (76,), 'entity', (63, 64, 65), ()) | predicted=('has_participant', 'event', (76,), 'entity', (64, 65), ())
- missing (10 shown):
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141,), 'entity', (135,), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 15 | 60 | 16 | 0.200 | 0.484 | 0.283 |
| event | 9 | 50 | 12 | 0.153 | 0.429 | 0.225 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 2 | 58 | 24 | 0.033 | 0.077 | 0.047 |

Suggested actions:
- entity: low F1 (0.283) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (149,), 'entity', (142, 143, 144, 145), ())
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 10 | 78 | 7 | 0.114 | 0.588 | 0.190 |
| event | 12 | 42 | 5 | 0.222 | 0.706 | 0.338 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 7 | 53 | 2 | 0.117 | 0.778 | 0.203 |
| event | 13 | 48 | 2 | 0.213 | 0.867 | 0.342 |
...
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.342) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (124,), 'entity', (126,), ())
  - predicted=('has_participant', 'event', (137,), 'entity', (136,), ())
