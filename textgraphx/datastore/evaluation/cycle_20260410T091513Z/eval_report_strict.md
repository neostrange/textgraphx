...
| micro | strict | event | 0.060 | 0.153 | 0.086 |
...
| macro | strict | entity | 0.125 | 0.392 | 0.183 |
| macro | strict | event | 0.063 | 0.152 | 0.086 |
| macro | strict | timex | 0.300 | 0.562 | 0.379 |
| macro | strict | relation | 0.058 | 0.121 | 0.076 |
| macro | relaxed | entity | 0.186 | 0.611 | 0.275 |
| macro | relaxed | event | 0.217 | 0.560 | 0.302 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.058 | 0.121 | 0.076 |
...
- Event Gain (relaxed - strict): 0.213
...
- event: micro F1=0.086 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 82738 | 0.108 | entity, event, timex, relation |
| 76437 | 0.116 | entity, event, timex, relation |
| 61327 | 0.172 | entity, event, timex, relation |
| 112579 | 0.187 | entity, event, timex, relation |
| 96770 | 0.236 | entity, event, timex, relation |
| 62405 | 0.268 | entity, event, relation |
...
| event | 2 | 32 | 10 | 0.059 | 0.167 | 0.087 |
...
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.087) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- type_mismatch (5 shown):
  ...
  - gold={'kind': 'event', 'span': [53], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'slip', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [53], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'followed', 'time': 'NON_FUTURE'}}
- missing (5 shown):
...
- spurious (10 shown):
  ...
  - predicted=('has_participant', 'event', (141,), 'entity', (132,), (('sem_role', 'Arg1'),))
...
| event | 2 | 57 | 19 | 0.034 | 0.095 | 0.050 |
...
- event: low F1 (0.050) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- type_mismatch (6 shown):
  ...
  - gold={'kind': 'event', 'span': [22], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'tumble', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [22], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'sent', 'time': 'NON_FUTURE'}}
  - gold={'kind': 'event', 'span': [52], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'fall', 'tense': 'PAST', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [52], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'fell', 'tense': 'PAST', 'time': 'NON_FUTURE'}}
- missing (10 shown):
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 84 | 13 | 0.045 | 0.235 | 0.076 |
| event | 2 | 52 | 15 | 0.037 | 0.118 | 0.056 |
...
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- event: low F1 (0.056) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- spurious (10 shown):
  ...
  - predicted={'kind': 'event', 'span': [128], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'transfer', 'tense': 'PAST', 'time': 'NON_FUTURE'}}
- timex:
- missing (2 shown):
...
| event | 3 | 58 | 12 | 0.049 | 0.200 | 0.079 |
...
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- event: low F1 (0.079) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
...
- event:
- boundary_mismatch (3 shown):
  - gold={'kind': 'event', 'span': [48, 49], 'attrs': {'aspect': 'PERFECTIVE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'know', 'tense': 'PRESENT', 'time': 'NON_FUTURE'}} | predicted={'kind': 'event', 'span': [48], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'crash', 'tense': 'PRESENT', 'time': 'NON_FUTURE'}}
...
- type_mismatch (7 shown):
  ...
  - gold={'kind': 'event', 'span': [20], 'attrs': {'aspect': 'NONE', 'certainty': 'POSSIBLE', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'repeat', 'tense': 'INFINITIVE', 'time': 'FUTURE'}} | predicted={'kind': 'event', 'span': [20], 'attrs': {'aspect': 'NONE', 'certainty': 'POSSIBLE', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'tend', 'tense': 'INFINITIVE', 'time': 'FUTURE'}}
- missing (2 shown):
...
- spurious (10 shown):
  - predicted={'kind': 'event', 'span': [42], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'crashed', 'time': 'NON_FUTURE'}}
  - predicted={'kind': 'event', 'span': [59], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'tumbling', 'time': 'NON_FUTURE'}}
  - predicted={'kind': 'event', 'span': [82], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'broke', 'time': 'NON_FUTURE'}}
- timex:
- boundary_mismatch (2 shown):
...
- spurious (10 shown):
  - predicted={'kind': 'event', 'span': [120], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'is', 'time': 'NON_FUTURE'}}
