...
- entity: micro F1=0.254 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.294 | entity, event, timex, relation |
| 82738 | 0.318 | entity, event, timex, relation |
| 62405 | 0.328 | entity, event, relation |
| 96770 | 0.329 | entity, event, timex, relation |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 11 | 27 | 20 | 0.289 | 0.355 | 0.319 |
| event | 8 | 43 | 13 | 0.157 | 0.381 | 0.222 |
| timex | 5 | 2 | 1 | 0.714 | 0.833 | 0.769 |
| relation | 0 | 0 | 26 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: low F1 (0.319) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 6 | 49 | 11 | 0.109 | 0.353 | 0.167 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 9 | 13 | 0.471 | 0.381 | 0.421 |
| event | 5 | 13 | 15 | 0.278 | 0.250 | 0.263 |
| timex | 4 | 6 | 0 | 0.400 | 1.000 | 0.571 |
| relation | 1 | 9 | 22 | 0.100 | 0.043 | 0.061 |

Suggested actions:
- entity: low F1 (0.421) - inspect extraction and matching rules for this layer.
