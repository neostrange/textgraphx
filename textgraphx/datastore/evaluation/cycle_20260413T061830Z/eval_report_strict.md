...
|---|---|---:|---:|---:|---:|
| micro | strict | entity | 0.144 | 0.283 | 0.190 |
| micro | strict | event | 0.158 | 0.279 | 0.202 |
| micro | strict | timex | 0.266 | 0.548 | 0.358 |
| micro | strict | relation | 0.091 | 0.015 | 0.026 |
| micro | relaxed | entity | 0.191 | 0.377 | 0.254 |
| micro | relaxed | event | 0.230 | 0.405 | 0.293 |
| micro | relaxed | timex | 0.391 | 0.806 | 0.526 |
| micro | relaxed | relation | 0.045 | 0.015 | 0.023 |
| macro | strict | entity | 0.170 | 0.290 | 0.199 |
| macro | strict | event | 0.191 | 0.293 | 0.207 |
| macro | strict | timex | 0.300 | 0.562 | 0.379 |
| macro | strict | relation | 0.075 | 0.014 | 0.024 |
| macro | relaxed | entity | 0.225 | 0.386 | 0.263 |
| macro | relaxed | event | 0.273 | 0.427 | 0.298 |
| macro | relaxed | timex | 0.410 | 0.778 | 0.524 |
| macro | relaxed | relation | 0.037 | 0.014 | 0.021 |
...
| tlink | 0.091 | 0.026 | 0.041 |

## Scorecards

### TimeML Compliance

- Strict Event F1: 0.202
- Strict TIMEX F1: 0.358
- Strict Relation F1: 0.026
- Composite: 0.196

### Beyond-TimeML Reasoning

- Event Gain (relaxed - strict): 0.091
...
- entity: micro F1=0.190 below threshold 0.75 - mark as priority optimization track.
...
- event: micro F1=0.202 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.026 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.121 | entity, event, timex, relation |
| 82738 | 0.142 | entity, event, timex, relation |
| 61327 | 0.186 | entity, event, timex, relation |
| 112579 | 0.222 | entity, event, timex, relation |
| 96770 | 0.243 | entity, event, timex, relation |
| 62405 | 0.299 | entity, event, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 5 | 29 | 8 | 0.147 | 0.385 | 0.213 |
| event | 6 | 8 | 20 | 0.429 | 0.231 | 0.300 |
| timex | 3 | 11 | 3 | 0.214 | 0.500 | 0.300 |
| relation | 1 | 3 | 22 | 0.250 | 0.043 | 0.074 |

Suggested actions:
- entity: low F1 (0.213) - inspect extraction and matching rules for this layer.
...
- relation: low F1 (0.074) - inspect extraction and matching rules for this layer.
...
- spurious (6 shown):
  - predicted={'kind': 'event', 'span': [311], 'attrs': {'aspect': 'NONE', 'certainty': 'POSSIBLE', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'rise', 'tense': 'INFINITIVE', 'time': 'FUTURE'}}
  - predicted={'kind': 'event', 'span': [332], 'attrs': {'aspect': 'NONE', 'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'VERB', 'pred': 'rise', 'tense': 'PAST', 'time': 'NON_FUTURE'}}
  - predicted={'kind': 'event', 'span': [349, 350], 'attrs': {'certainty': 'CERTAIN', 'polarity': 'POS', 'pos': 'NOUN', 'pred': 'rise', 'time': 'NON_FUTURE'}}
- timex:
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 22 | 11 | 0.154 | 0.267 | 0.195 |
...
- entity: low F1 (0.195) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 9 | 29 | 22 | 0.237 | 0.290 | 0.261 |
| event | 6 | 45 | 15 | 0.118 | 0.286 | 0.167 |
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 52 | 14 | 0.055 | 0.176 | 0.083 |
| event | 5 | 38 | 12 | 0.116 | 0.294 | 0.167 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 0 | 13 | 21 | 0.000 | 0.000 | 0.000 |

Suggested actions:
- entity: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- entity: low F1 (0.083) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 36 | 6 | 0.077 | 0.333 | 0.125 |
| event | 7 | 38 | 8 | 0.156 | 0.467 | 0.233 |
...
| event | 3 | 15 | 17 | 0.167 | 0.150 | 0.158 |
...
- event: boundary mismatches detected - verify token span anchoring (`start_tok`, `end_tok`) and overlap threshold.
- event: low F1 (0.158) - inspect extraction and matching rules for this layer.
- event: recall is weaker than precision - investigate under-generation and missing extractions.
- event: type mismatches detected - tune label/attribute mapping in mapping-config.
