...
- entity: micro F1=0.087 below threshold 0.75 - mark as priority optimization track.
...
|---|---:|---|
| 76437 | 0.022 | entity, event, timex, relation |
...
|---|---:|---:|---:|---:|---:|---:|
| entity | 3 | 49 | 14 | 0.058 | 0.176 | 0.087 |
...
- entity: low F1 (0.087) - inspect extraction and matching rules for this layer.
