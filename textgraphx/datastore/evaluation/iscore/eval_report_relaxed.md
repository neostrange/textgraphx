...
- entity: micro F1=0.234 below threshold 0.75 - mark as priority optimization track.
...
- relation: micro F1=0.056 below threshold 0.75 - mark as priority optimization track.
...
| 112579 | 0.271 | entity, event, timex, relation |
| 82738 | 0.295 | entity, event, timex, relation |
| 62405 | 0.349 | entity, event, relation |
| 96770 | 0.352 | entity, event, timex, relation |
...
| relation | 3 | 34 | 20 | 0.081 | 0.130 | 0.100 |
...
- relation: low F1 (0.100) - inspect extraction and matching rules for this layer.
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (322,), 'entity', (313, 314, 315, 316), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (322,), 'entity', (174, 175, 176, 177), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (116,), 'entity', (112,), (('sem_role', 'Arg1'),))
...
| relation | 0 | 19 | 16 | 0.000 | 0.000 | 0.000 |
...
- spurious (10 shown):
  - predicted=('has_participant', 'event', (151,), 'entity', (164,), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (184,), 'entity', (181, 182, 183), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (151,), 'entity', (264,), (('sem_role', 'Arg0'),))
...
| relation | 2 | 9 | 24 | 0.182 | 0.077 | 0.108 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.108) - inspect extraction and matching rules for this layer.
- timex: precision is weaker than recall - investigate over-generation and filtering criteria.
...
- spurious (9 shown):
  ...
  - predicted=('has_participant', 'event', (52,), 'entity', (53, 54), (('sem_role', 'Arg2'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 8 | 94 | 9 | 0.078 | 0.471 | 0.134 |
| event | 12 | 53 | 5 | 0.185 | 0.706 | 0.293 |
| timex | 2 | 11 | 2 | 0.154 | 0.500 | 0.235 |
| relation | 1 | 58 | 20 | 0.017 | 0.048 | 0.025 |

Suggested actions:
- entity: low F1 (0.134) - inspect extraction and matching rules for this layer.
- entity: precision is weaker than recall - investigate over-generation and filtering criteria.
- event: low F1 (0.293) - inspect extraction and matching rules for this layer.
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.025) - inspect extraction and matching rules for this layer.
...
- spurious (10 shown):
  - predicted=('tlink', 'event', (26,), 'timex', (15,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('has_participant', 'event', (174,), 'entity', (175, 176, 177), (('sem_role', 'Arg1'),))
  - predicted=('has_participant', 'event', (230,), 'entity', (228, 229), (('sem_role', 'Arg1'),))
...
| Layer | TP | FP | FN | Precision | Recall | F1 |
|---|---:|---:|---:|---:|---:|---:|
| entity | 4 | 72 | 5 | 0.053 | 0.444 | 0.094 |
| event | 12 | 57 | 3 | 0.174 | 0.800 | 0.286 |
| timex | 7 | 5 | 0 | 0.583 | 1.000 | 0.737 |
| relation | 1 | 9 | 21 | 0.100 | 0.045 | 0.063 |
...
- event: precision is weaker than recall - investigate over-generation and filtering criteria.
- relation: low F1 (0.063) - inspect extraction and matching rules for this layer.
...
- missing (10 shown):
  ...
  - gold=('tlink', 'timex', (23,), 'timex', (51, 52), (('reltype', 'SIMULTANEOUS'),))
  - gold=('tlink', 'event', (24,), 'timex', (11, 12, 13, 14), (('reltype', 'SIMULTANEOUS'),))
- spurious (9 shown):
  - predicted=('has_participant', 'event', (160,), 'entity', (153, 154, 155, 156), (('sem_role', 'Arg2'),))
  - predicted=('has_participant', 'event', (185,), 'entity', (181, 182), (('sem_role', 'Arg0'),))
  - predicted=('has_participant', 'event', (216,), 'entity', (217, 218, 219), (('sem_role', 'Arg2'),))
...
| relation | 1 | 16 | 22 | 0.059 | 0.043 | 0.050 |
...
- missing (10 shown):
  ...
  - gold=('tlink', 'event', (51,), 'timex', (9, 10, 11, 12), (('reltype', 'IS_INCLUDED'),))
- spurious (10 shown):
  - predicted=('tlink', 'event', (32,), 'timex', (21,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('tlink', 'event', (15,), 'timex', (21,), (('reltype', 'IS_INCLUDED'),))
  - predicted=('has_participant', 'event', (51,), 'entity', (52, 53), (('sem_role', 'Arg2'),))
